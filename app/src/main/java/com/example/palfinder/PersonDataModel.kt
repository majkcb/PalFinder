...
object PersonDataModel {
    val persons = mutableListOf<PersonGammal>()
    ...
    fun createMockData() {
        ...
        val person01 = PersonGammal(R.drawable.playing_card_heart_ace,"Appert Nifortam","Ankeborg", "012-345 67 01")
        val person02 = PersonGammal(R.drawable.playing_card_club_2,"Boloph Mirapgolp","Långtbortistan", "012-345 67 02")
        val person03 = PersonGammal(R.drawable.playing_card_club_3,"Cabemu Lwapordim","Gåseby", "012-345 67 03")
        val person04 = PersonGammal(R.drawable.playing_card_club_4,"Dålott Karlstomp","GothamCity", "012-345 67 04")
        val person05 = PersonGammal(R.drawable.playing_card_club_5,"Elifot Grump","Smallville", "012-345 67 05")
        val person06 = PersonGammal(R.drawable.playing_card_club_6,"Fepotp Pitepnint","Utkanten", "012-345 67 06")
        val person07 = PersonGammal(R.drawable.playing_card_club_7,"Giplop Hupjamtap","Campus", "012-345 67 07")
        val person08 = PersonGammal(R.drawable.playing_card_club_8,"Hutmep Qripmant","UrbanSprawl", "012-345 67 08")
        val person09 = PersonGammal(R.drawable.playing_card_club_9,"Ilfemt Eslogwah","Vartunda", "012-345 67 09")
        val person10 = PersonGammal(R.drawable.playing_card_club_10,"Jafoot Ropertopp","Varsätra", "012-345 67 10")
        val person11 = PersonGammal(R.drawable.playing_card_club_jack,"Keplot Zyxlamtin","Kakariko", "012-345 67 11")
        val person12 = PersonGammal(R.drawable.playing_card_club_queen,"Lariib Mwoor","Hyrule", "012-345 67 12")
        val person13 = PersonGammal(R.drawable.playing_card_club_king,"Metnop Dåpeltopp","Skotorp", "012-345 67 13")
        val person14 = PersonGammal(R.drawable.playing_card_club_ace,"Nifmet Qrampelstamp","Ankeborg", "012-345 67 14")
        val person15 = PersonGammal(R.drawable.playing_card_diamond_2,"Opeth Deliverance","Långtbortistan", "012-345 67 15")
        val person16 = PersonGammal(R.drawable.playing_card_diamond_3,"Pnuref Hakselbax","Jämmerdalen", "012-345 67 16")
        val person17 = PersonGammal(R.drawable.playing_card_diamond_4,"Qitrop Irrevall","GothamCity", "012-345 67 17")
        val person18 = PersonGammal(R.drawable.playing_card_diamond_5,"Ropypt Jimpedum","Utkanten", "012-345 67 18")
        val person19 = PersonGammal(R.drawable.playing_card_diamond_6,"Surtep Jeffemyr","Gåseby", "012-345 67 19")
        val person20 = PersonGammal(R.drawable.playing_card_diamond_7,"Tognor Xylt","Smallville", "012-345 67 20")
        val person21 = PersonGammal(R.drawable.playing_card_diamond_8,"Unipem Hoffpott","UrbanSprawl", "012-345 67 21")
        val person22 = PersonGammal(R.drawable.playing_card_diamond_9,"Volroj Bjarteprapp","Varsätra", "012-345 67 22")
        val person23 = PersonGammal(R.drawable.playing_card_diamond_10,"Wiptos Higvardsen","Campus", "012-345 67 23")
        val person24 = PersonGammal(R.drawable.playing_card_diamond_jack,"Xumoph Gottbert","Hyrule", "012-345 67 24")
        val person25 = PersonGammal(R.drawable.playing_card_diamond_queen,"Ypmoth Ålpelur","Kakariko", "012-345 67 25")
        val person26 = PersonGammal(R.drawable.playing_card_diamond_king,"Zurept Ähöva","Utkanten", "012-345 67 26")
        val person27 = PersonGammal(R.drawable.playing_card_diamond_ace,"Åplamk Rustetrupp","Gåseby", "012-345 67 27")
        val person28 = PersonGammal(R.drawable.playing_card_heart_2,"Äpalum Ögfabäbå","Vartunda", "012-345 67 28")
        val person29 = PersonGammal(R.drawable.playing_card_heart_3,"Öfnult Rittnils","Utkanten", "012-345 67 29")
        ...
        person07.interests.plusAssign(arrayOf(PossibleInterests.WILD_LIFE,PossibleInterests.ART,PossibleInterests.DISC_GOLF,PossibleInterests.DANCING,PossibleInterests.FAST_CARS))
        ...
        person18.interests.plusAssign(arrayOf(PossibleInterests.UNUSUAL_LANGUAGES,PossibleInterests.DANCING,PossibleInterests.BIKES,PossibleInterests.FASHION_DESIGN,PossibleInterests.WILD_LIFE))
        person19.interests.plusAssign(arrayOf(PossibleInterests.BIKES,PossibleInterests.DANCING,PossibleInterests.WILD_LIFE,PossibleInterests.GOLF,PossibleInterests.MOTORCYCLES))
        ...
        person29.interests.plusAssign(arrayOf(PossibleInterests.ART,PossibleInterests.DANCING,PossibleInterests.BIKES,PossibleInterests.FISHING))
